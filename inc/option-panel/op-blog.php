<?php
    ...
    $wp_customize->add_setting('educare_show_blog_sidebar_settings', array(
        'capability'        => 'edit_theme_options',
        'transport'         => 'refresh',
        'type'              => 'theme_mod',
        'sanitize_callback' => function( $input ) {
    ...
    $wp_customize->add_control('educare_show_blog_sidebar_ctrl', array(
        'label'             =>  __('Show Blog Page Sidebar', 'educare'),
        'section'           =>  'educare_blog',
        'settings'          =>  'educare_show_blog_sidebar_settings',
        'type'              =>  'checkbox'
    ));
